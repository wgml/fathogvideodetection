...
using vec_uchar_3 = cv::Vec<uchar, 3>;
// ------------------------------------------------------------------------------------------------------------
// queue_roi
// ------------------------------------------------------------------------------------------------------------
...
void queue_roi::computeROIlineParams() {
    ...
    // ------------------------------------------------------------------------------------------------------------
    singleLineParam(0, m_queueROI.TL.x, m_queueROI.TL.y, m_queueROI.BL.x, m_queueROI.BL.y,
                    true);   // TL BL
    singleLineParam(1, m_queueROI.TR.x, m_queueROI.TR.y, m_queueROI.BR.x, m_queueROI.BR.y,
                    false);  // TR BR
    singleLineParam(2, m_queueROI.TR.x, m_queueROI.TR.y, m_queueROI.TL.x, m_queueROI.TL.y,
                    true);  // TR TL
    singleLineParam(3, m_queueROI.BL.x, m_queueROI.BL.y, m_queueROI.BR.x, m_queueROI.BR.y,
                    false);  // BR BL
}
