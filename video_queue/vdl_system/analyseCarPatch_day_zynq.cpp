...
int analyseCarPatch_day_zynq(unsigned char rgbImage[][VDL_MAX_VDL_WIDTH][4], int vdl_line_width, int car_patch_height){
	...
	// Tablice
	static unsigned char rgbImageAdj[VDL_MAX_VDL_HEIGHT][VDL_MAX_VDL_WIDTH][3];           // obraz po rozci¹ganiu histogramu
	static unsigned char rgbImageFiltered[VDL_MAX_VDL_HEIGHT][VDL_MAX_VDL_WIDTH][3];      // obraz po filtracji Gaussa

	// Temporary
	static unsigned char edgeShadowImage[VDL_MAX_VDL_HEIGHT][VDL_MAX_VDL_WIDTH][3];
	...
	int edgeShadowSumX[VDL_MAX_VDL_WIDTH] = { 0 };        // suma krawedzi i cienia poziomo
	int edgeShadowSumY[VDL_MAX_VDL_HEIGHT] = { 0 };       // suma krawedzi i cienia pionowo
	...
	unsigned char segL[VDL_MAX_VDL_HEIGHT][VDL_MAX_VDL_WIDTH] = { 0 };
	unsigned char segL_D[VDL_MAX_VDL_HEIGHT][VDL_MAX_VDL_WIDTH] = { 0 };

	unsigned char segR[VDL_MAX_VDL_HEIGHT][VDL_MAX_VDL_WIDTH] = { 0 };
	unsigned char segR_D[VDL_MAX_VDL_HEIGHT][VDL_MAX_VDL_WIDTH] = { 0 };
	...
	for (i = 1; i < VDL_MAX_VDL_HEIGHT; i++) {
	...
	for (i = VDL_MAX_VDL_HEIGHT - 2; i >= 0; i--) {
		if (edgeShadowSumY[i] > EDGE_SHADOW_NUM_TH) {
			edgeYEnd = i;
			break;
		}
	...
	for (i = VDL_MAX_VDL_WIDTH - 2; i >= 0; i--) {
		if (edgeShadowSumX[i] > EDGE_SHADOW_NUM_TH) {
			edgeXEnd = i;
			break;
		}
